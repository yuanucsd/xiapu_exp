...
/*csvFile is the csv that will be saved at the end of the experiment*/
      var csvFile = [["trial_num", "radio_value", "word_selected", "tone_selected","scale_value", "word_list", "sound", "stimuli_length", "stimuli_tone", "stimuli_gl", "neu_between", "answer", "trial_sequence"]];
...
/*push the trial number, radio value, word value, and scale value to the csv file*/          
          ...
          /*stimuli_gl get the tone of the stimuli*/
            ...
            var curresultList = [curTrial, radioselectedValue, wordselectedValue, toneselectedValue, scaleValue, wordListString, trialListRandom[curTrial].path, stimuli_length, stimuli_tone, stimuli_gl, neu_between, stimuli_answer, trialListRandom[curTrial].seq]
